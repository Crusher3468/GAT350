...
namespace neu
{
	...
	extern const uint32_t Wkey;
	extern const uint32_t Akey;
	extern const uint32_t Skey;
	extern const uint32_t Dkey;
	extern const uint32_t Qkey;
	extern const uint32_t Ekey;
}
